...
main: main.o machine.o piece.o robot_retrait.o superviseur.o Th_Robot_alimentation.o fonctions_utiles.o predicat_liste.o
	$(CC) -o main main.o machine.o piece.o robot_retrait.o superviseur.o Th_Robot_alimentation.o $(LDFLAGS)
	
	
	
main.o: main.c fonctions_utiles.h 
